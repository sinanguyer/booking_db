...
def get_calendar_events():
    ...
    cursor.execute('''
        SELECT sd.date || 'T' || h.name AS start, c.name AS title, h.name AS hour, sd.inverter, GROUP_CONCAT(e.name) AS equipment, sd.id, 1 as is_selected
